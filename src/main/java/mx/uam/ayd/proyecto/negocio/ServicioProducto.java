...
public class ServicioProducto {
	...
	/**
	 * Inyección de dependencias {@link ProductoRepository} con sus Getters and Setters
	 ...
	 * En caso de no existir productos regresa una lista vacía.
	 * 
	 * @see mx.uam.ayd.proyecto.negocio.modelo.Producto#isEscacez()
	 * @return una {@literal List} de Productos. Si no hay productos regresa {@literal List} vacía
	 */
	...
	/**
	 * Aumenta el atributo cantidad del producto especificado en la cantidad pasada por parámetro SI hay espacio
	 * en el inventario, véase método {@link #validaInventario(Producto, Integer)}, y regresa true
	 ...
	 * @return {@literal true} si se aumentó la cantidad o {@literal false} si no existe el producto
	 */
	...
	/**
	 * Valida que la cantidad pasada por parámetro no exceda el límite de la capacidad del inventario, 
	 * y no sea menor que el mínimo del producto (RN-13), si se cumple la regresa la cantidadNueva.
	 * 
	 ...
	 * @return {@literal Integer} si cumple la validación o {@literal null} si no es valida
	 */
	public Integer validaInventario(Producto producto, Integer cantidad) {
		...
		try {
			...
			// Limite: Debe abastecer el mínimo del inventario especificado en la RN-13
	...
	/**
	 * Este metodo crea un producto para ser guardado en la base de datos
	 * 
	 * @param fecha Fecha en la que se creo el producto
	 * @param nombreProducto Nombre que se le va asignar al producto
